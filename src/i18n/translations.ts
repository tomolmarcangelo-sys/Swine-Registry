...
export const translations: Record<Language, TranslationDictionary> = {
  ...
  en: {
    ...
    nav: {
      ...
      gis: 'GIS Swine Spatial Surveillance',
      recordsAdmin: 'Municipal Swine Registry',
      recordsFocal: 'Barangay Swine Records',
      print: 'Print Official Reports',
      accounts: 'Focal Accounts & System Settings',
      addSwine: 'Register Swine Record',
      signOut: 'Sign Out',
      publicPortal: 'Public Information Portal'
    },
    topbar: {
      executiveDashboard: 'Municipal Swine Registry Dashboard',
      gisMapTitle: 'GIS Swine Spatial Surveillance',
      recordsAdminTitle: 'Municipal Swine Registry Database',
      recordsFocalTitle: 'Barangay {barangay} Swine Records',
      accountsTitle: 'Focal Accounts & System Settings',
      printTitle: 'Official Reports Generator',
      scopeAll: 'Scope: All 40 Barangays',
      scopeBarangay: 'Scope: Barangay {barangay}',
      liveOnline: 'Realtime Sync Active',
      offlineMode: 'Offline Mode',
      queuedItems: '{count} Pending Sync'
    },
    sidebar: {
      brandTitle: 'Hinunangan DA',
      brandSubtitle: 'Swine Registry & GIS Platform',
      roleAdmin: 'Central DA Administrator',
      roleFocal: 'Brgy. {barangay} Focal Officer',
      quickRegister: 'Register Swine Record',
      installPwa: 'Install Offline Platform',
      signOutConfirm: 'Are you sure you want to sign out?'
    },
    dashboard: {
      title: 'Municipal Swine Registry Dashboard',
      subtitle: 'Official livestock census, biosecurity status, and spatial herd management across Hinunangan\'s 40 barangays.',
      ...
      registerNewSwine: 'Register Swine Record',
      printOfficialReports: 'Generate Official Reports',
      recentRegistrations: 'Recent Swine Registrations',
      noRegistrations: 'No swine records logged yet.',
      biosecurityOverview: 'Biosecurity Risk Assessment',
      purposeBreakdown: 'Herd Purpose Classification',
    ...
    records: {
      title: 'Municipal Swine Registry',
      ...
      searchPlaceholder: 'Search by ear tag number, owner name, address, or breed...',
      filterBarangay: 'Filter by Barangay',
      filterPurpose: 'Filter by Purpose',
      filterVax: 'Filter by Health Status',
      allBarangays: 'All Barangays (40 Sectors)',
      allPurposes: 'All Production Purposes',
      allVaxStatus: 'All Health Statuses',
      vaccinatedOnly: 'Vaccinated & Protected',
      unvaccinatedOnly: 'Unvaccinated / Pending Review',
      colEarTag: 'Ear Tag Number',
      colOwner: 'Owner & Contact Info',
      colLocation: 'Farm Location & Barangay',
      colBreedSex: 'Breed & Sex',
      colWeightAge: 'Weight & Age',
      colVax: 'Vaccination & ASF Status',
      colBiosecurity: 'Biosecurity Score',
      colActions: 'Actions',
      noRecordsFound: 'No Swine Records Found',
      noRecordsSub: 'No swine records match the selected filters. Register a new herd to start spatial surveillance.',
      showingRecords: 'Showing {count} of {total} registered swine records',
      viewOnMap: 'View on GIS Map',
      editRecord: 'Edit Swine Record',
      deleteRecord: 'Delete Swine Record',
      confirmDelete: 'Are you sure you want to delete swine record {earTag}? This action cannot be undone.'
    },
    gis: {
      mapViewTitle: 'GIS Swine Spatial Surveillance',
      mapViewSubtitle: 'Real-time farm coordinates, density clusters, and biosecurity risk assessments across Hinunangan',
      ...
      highBiosecurity: 'Level 3: Certified Biosecure (85–100%)',
      mediumBiosecurity: 'Level 2: Standard Biosecure (55–84%)',
      lowBiosecurity: 'Level 1: Basic / High Risk (<55%)',
      legendTitle: 'Biosecurity Risk Assessment Legend',
      legendDescription: 'Color markers indicate farm compliance with national DA biosecurity guidelines:',
      legendSwineClassification: 'Swine Production Purpose',
      legendBiosecurityCoding: 'Biosecurity Score Assessment',
      legendGreenExplanation: 'High Biosecurity (Level 3 / 6–7 pts) — Full footbath, perimeter barrier, zero-swill compliance',
      legendYellowExplanation: 'Standard Biosecurity (Level 2 / 4–5 pts) — Basic disinfection in place with moderate containment',
      ...
      sanitationScore: 'Biosecurity Score',
      captureCoords: 'Capture Current GPS',
      recenterMap: 'Recenter Map',
      quarantineRadius: '1.0 km Quarantine Buffer Ring',
      clickToAddPrompt: 'Click on the map to plot swine farm coordinates',
      farmsNearby: '{count} farms within 1 km radius',
      boundaryRestrictedToast: 'Swine registrations are restricted to Hinunangan municipal boundaries.',
    ...
    modal: {
      titleNew: 'Register Swine Record',
      titleEdit: 'Update Swine Record — {earTag}',
      deptHeader: 'Department of Agriculture · Hinunangan',
      sectionLocation: 'Live Map Coordinates (GIS Location)',
      sectionOwner: 'Owner & Contact Information',
      sectionSpecs: 'Swine Specifications & Health Status',
      sectionBiosecurity: 'Farm Biosecurity & Disease Prevention Checklist',
      sectionNotes: 'Field Notes & Clinical Observations',
      earTagLabel: 'Ear Tag Number *',
      ownerNameLabel: 'Owner Full Name *',
      contactLabel: 'Contact Number (Mobile)',
      addressLabel: 'Physical Address (Purok / Sitio) *',
      barangayLabel: 'Barangay *',
      breedLabel: 'Breed *',
      sexLabel: 'Sex *',
      ageLabel: 'Age (Months) *',
      weightLabel: 'Estimated Weight (kg) *',
      purposeLabel: 'Production Purpose *',
      vaccinatedCheckbox: 'Vaccinated (Hog Cholera / Erysipelas)',
      asfClearedCheckbox: 'ASF Biosecurity Clearance Certified',
      dateRegisteredLabel: 'Date Registered *',
      photoLabel: 'Swine / Pen Photo Verification (Optional)',
      photoHelper: 'Upload or capture an ear tag or pen inspection photo for record verification.',
      savingBtn: 'Saving to Registry...',
      saveBtn: 'Register Swine Record',
      updateBtn: 'Save Updates',
      cancelBtn: 'Cancel'
    },
    biosecurity: {
      sectionTitle: 'Farm Biosecurity & Disease Prevention Checklist',
      scoreLabel: 'Compliance Score: {score}% ({count}/{total} criteria satisfied)',
      level3High: 'Level 3: Certified High Biosecurity',
    ...
    notifications: {
      ...
      syncQueued: 'Record saved locally and queued for realtime sync.',
      syncCompleted: 'Realtime synchronization completed successfully.',
      syncFailed: 'We\'re having trouble reaching the database. Your records are safely stored locally.',
      offlineMode: 'Offline Mode active. Records will auto-sync when connection is restored.',
      onlineRestored: 'Realtime connection active. Database synchronized.',
  ...
  ceb: {
    ...
    nav: {
      dashboard: 'Pangulong Dashboard',
      gis: 'GIS Mapa sa Baboy & Pagbantay',
      recordsAdmin: 'Sentral nga Rehistro sa Baboy',
      recordsFocal: 'Mga Rekord sa Barangay',
    ...
    topbar: {
      executiveDashboard: 'Pangulong Dashboard sa Baboy',
      gisMapTitle: 'GIS Mapa sa Baboy & Pagbantay',
      recordsAdminTitle: 'Sentral nga Database sa Baboy',
      ...
      scopeBarangay: 'Sakop: Barangay {barangay}',
      liveOnline: 'Aktibo ang Realtime Sync',
      offlineMode: 'Offline Mode',
      queuedItems: '{count} ang Nalinya sa Pag-sync'
    },
    sidebar: {
      brandTitle: 'Hinunangan DA',
      brandSubtitle: 'Rehistro sa Baboy & GIS Plataporma',
      roleAdmin: 'Sentral nga Administrador sa DA',
      roleFocal: 'Focal Officer sa Brgy. {barangay}',
      quickRegister: 'Pagrehistro og Baboy',
      installPwa: 'I-install ang App (Mugana Offline)',
      signOutConfirm: 'Sigurado ka ba nga mogawas sa sistema?'
    },
    dashboard: {
      title: 'Dashboard sa Rehistro sa Baboy',
      subtitle: 'Opisyal nga programa sa panguma sa Hinunangan, Southern Leyte alang sa biosecurity ug census.',
      ...
      printOfficialReports: 'Paghimo og Opisyal nga Taho',
      recentRegistrations: 'Bag-ong Narehistro nga mga Baboy',
      noRegistrations: 'Wala pay narehistro nga baboy.',
      biosecurityOverview: 'Pagsusi sa Peligro sa Biosecurity',
    ...
    gis: {
      mapViewTitle: 'GIS Mapa sa Baboy & Pagbantay',
      mapViewSubtitle: 'Tinuod nga koordinasyon sa tangkal, densidad, ug pagsusi sa biosecurity sa tibuok Hinunangan',
      ...
      highBiosecurity: 'Level 3: Sertipikado nga Biosecure (85–100%)',
      mediumBiosecurity: 'Level 2: Sakto nga Biosecure (55–84%)',
      lowBiosecurity: 'Level 1: Ubos / Peligro (<55%)',
      legendTitle: 'Giya sa Kolor sa Biosecurity',
      legendDescription: 'Ang mga kolor sa marka nagpakita sa pagsunod sa mga lagda sa DA:',
      legendSwineClassification: 'Katuyoan sa Pag-alima sa Baboy',
      legendBiosecurityCoding: 'Pagsusi sa Puntos sa Biosecurity',
    ...
    modal: {
      titleNew: 'Pagrehistro og Baboy',
      titleEdit: 'Pag-usab sa Rehistro — {earTag}',
      deptHeader: 'Departamento sa Agrikultura · Hinunangan',
      sectionLocation: 'Koordinasyon sa Mapa (GIS Lokasyon)',
      sectionOwner: 'Impormasyon sa Tag-iya & Numero',
      sectionSpecs: 'Karakteristika sa Baboy & Panglawas',
      sectionBiosecurity: 'Pagsusi sa Biosecurity & Pagpugong sa Sakit',
      sectionNotes: 'Mubo nga Sulat sa Pag-inspeksyon',
      earTagLabel: 'Numero sa Ear Tag *',
      ...
      photoHelper: 'I-upload ang litrato sa ear tag o tangkal aron mapamatud-an ang rekord.',
      savingBtn: 'Girehistro pa...',
    ...
    notifications: {
      ...
      syncFailed: 'Nalisdan sa pagkonekta sa database. Luwas nga naluwas ang imong rekord locally.',
      offlineMode: 'Offline Mode. Ang tanang datos awtomatikong ma-sync inig balik sa signal.',
