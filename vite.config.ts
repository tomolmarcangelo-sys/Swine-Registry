  ...
  return {
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          id: '/',
          name: 'DA Hinunangan Swine Registry & Biosecurity GIS',
          short_name: 'SwineGIS',
          description: 'Municipal Swine Registry, Biosecurity Tracking, and Offline GPS Mapping for Hinunangan, Southern Leyte.',
          theme_color: '#065f46',
